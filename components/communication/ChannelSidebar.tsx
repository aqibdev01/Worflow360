...
export function CommunicationSidebar({
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div className="w-[260px] border-r bg-[#F8F9FC] flex flex-col h-full">
        {/* Header */}
        <div className="px-4 py-3 border-b">
          <h2 className="text-base font-bold text-navy-900">Messages</h2>
                ...
                {showChannels && archivedChannels.length > 0 && (
                  <>
                    <button
                      ...
                      className="flex items-center gap-1.5 px-4 py-1.5 mt-1 text-xs text-muted-foreground hover:text-navy-900 w-full"
                    >
