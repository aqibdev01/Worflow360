  ...
  return (
    <div className="relative border-t bg-white dark:bg-slate-950">
      ...
      {showMentions && filteredMembers.length > 0 && (
        <div className="absolute bottom-full left-4 right-4 mb-1 bg-white dark:bg-slate-900 border dark:border-slate-700 rounded-lg shadow-lg max-h-48 overflow-y-auto z-20">
          {filteredMembers.slice(0, 8).map((member, idx) => (
            ...
            >
              <div className="h-6 w-6 rounded-full bg-gradient-to-br from-indigo-500 to-cyan-400 flex items-center justify-center flex-shrink-0">
