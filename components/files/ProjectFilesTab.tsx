...
export function ProjectFilesTab({ orgId, projectId }: ProjectFilesTabProps) {
  const fileManager = useFileManager({ orgId, projectId });
  ...
  const [shareFileTarget, setShareFileTarget] = useState<FileRecord | null>(null);
